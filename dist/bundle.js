...
var UPDATE_TOP_STORIES = exports.UPDATE_TOP_STORIES = 'update_top_stories';
var UPDATE_INDEX = exports.UPDATE_INDEX = 'update_index';
var UPDATE_STORY_URL = exports.UPDATE_STORY_URL = 'update_story_url';
var TOGGLE_LOADER = exports.TOGGLE_LOADER = 'toggle_loader';
var SET_LOADER_TEXT = exports.SET_LOADER_TEXT = 'set_loader_text';
var SET_LOADED_CARDS_COUNTER = exports.SET_LOADED_CARDS_COUNTER = 'set_loaded_cards_counter';
var UPDATE_SELECTED_STORIES = exports.UPDATE_SELECTED_STORIES = 'update_selected_stories';
var ADD_STORY_TO_SELECTION = exports.ADD_STORY_TO_SELECTION = 'add_story_to_selection';
var RESET_SELECTED_STORIES = exports.RESET_SELECTED_STORIES = 'reset_selected_stories';
var UPDATE_SCREEN = exports.UPDATE_SCREEN = 'update_screen';
var UPDATE_STORY_STORE = exports.UPDATE_STORY_STORE = 'update_store';

/*screens*/
var LIST_STORIES = exports.LIST_STORIES = 'list_stories';
var READING_SESSION = exports.READING_SESSION = 'reading_session';
...
var _StateActions = __webpack_require__(104);

Object.keys(_StateActions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _StateActions[key];
    }
  });
});
...
var _CommentCard = __webpack_require__(110);
...
var Comments = function (_Component) {
    ...
    function Comments() {
        ...
        _this.generateComments = _this.generateComments.bind(_this);
        return _this;
    }

    _createClass(Comments, [{
        key: 'generateComments',
        value: function generateComments() {
            var markup = [];
            for (var i = 0; i < this.props.comments.length; i++) {
                markup.push(_react2.default.createElement(_CommentCard2.default, { key: this.props.comments[i].id,
                    title: this.props.comments[i].text,
                    children: this.props.comments[i].children.filter(function (child) {
...
var m=__webpack_require__(5),n=__webpack_require__(8),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(18),B=__webpack_require__(5),C=__webpack_require__(3),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(8);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(72)(module)))
...
var _StateReducer = __webpack_require__(83);

var _StateReducer2 = _interopRequireDefault(_StateReducer);

var _ConfigReducer = __webpack_require__(84);
...
exports.default = (0, _redux.combineReducers)({
	currentState: _StateReducer2.default,
	configuration: _ConfigReducer2.default
});
...
var INITIAL_STATE = {
	loader: false,
	currentScreen: _types.LIST_STORIES,
...
exports.default = function () {
	...
	switch (action.type) {
		case _types.UPDATE_TOP_STORIES:
			return _extends({}, state, { topStories: action.payload });
		case _types.UPDATE_INDEX:
			return _extends({}, state, { index: action.payload });
		case _types.TOGGLE_LOADER:
			return _extends({}, state, { loader: action.payload });
		case _types.SET_LOADER_TEXT:
			return _extends({}, state, { loaderText: action.payload });
		case _types.SET_LOADED_CARDS_COUNTER:
			return _extends({}, state, { loadedCardsCounter: action.payload });
		case _types.UPDATE_SELECTED_STORIES:
			return _extends({}, state, { selectedStories: action.payload });
		case _types.UPDATE_SCREEN:
			return _extends({}, state, { currentScreen: action.payload });
		case _types.UPDATE_STORY_STORE:
			return _extends({}, state, { storyStore: action.payload });
		default:
			return state;
	}
};
...
exports.default = function () {
	...
	switch (action.type) {
		case _types.UPDATE_STORY_URL:
			return _extends({}, state, { storyURL: action.payload });
		case _types.UPDATE_TOP_STORIES_URL:
			return _extends({}, state, { topStoriesURL: action.payload });
		default:
			return state;
	}
};
...
var _MainMenu = __webpack_require__(107);

var _MainMenu2 = _interopRequireDefault(_MainMenu);

var _StoryMode = __webpack_require__(108);

var _StoryMode2 = _interopRequireDefault(_StoryMode);
...
var Root = function (_Component) {
    ...
    function Root() {
        ...
        _this.fetchTopStories = _this.fetchTopStories.bind(_this);
        _this.updateIndex = _this.updateIndex.bind(_this);
        _this.generateCards = _this.generateCards.bind(_this);
        _this.incrementLoadedCards = _this.incrementLoadedCards.bind(_this);
        _this.state = {
            loadedCards: 0
        };
        return _this;
    ...
    _createClass(Root, [{
        ...
        value: function incrementLoadedCards() {
            var alreadyLoaded = this.state.loadedCards;
        ...
        value: function generateCards() {
            ...
            if (this.props.currentState.topStories.length) {
                for (var i = this.props.currentState.index; i < this.props.currentState.index + 10; i++) {
                    var selectedStories = this.props.currentState.selectedStories;

                    var isSelected = this.props.currentState.selectedStories.indexOf(this.props.currentState.topStories[i]) > -1 ? true : false;
                    var trigger = i == this.props.currentState.index ? true : false;
                    cards.push(_react2.default.createElement(_Card2.default, { key: this.props.currentState.topStories[i], isSelected: isSelected, id: this.props.currentState.topStories[i], url: this.props.configuration.storyURL, onCompletion: this.incrementLoadedCards }));
                }
            }
            return cards;
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_MainMenu2.default, { currentScreen: this.props.currentState.currentScreen }),
                this.generateCards(),
                this.props.currentState.currentScreen === 'list_stories' ? _react2.default.createElement('input', { type: 'button', value: 'Next', className: 'showMore-btn', onClick: this.updateIndex }) : '',
                this.props.currentState.currentScreen === 'reading_session' ? _react2.default.createElement(_StoryMode2.default, null) : ''
            );
        }
    }]);
...
var mapStateToProps = function mapStateToProps(state) {
    ...
    return { currentState: currentState, configuration: configuration };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, { updateTopStories: _actions.updateTopStories, toggleLoader: _actions.toggleLoader, setLoaderText: _actions.setLoaderText, setLoadedCardsCounted: _actions.setLoadedCardsCounted, updateIndex: _actions.updateIndex, removeAllStoriesFromSelection: _actions.removeAllStoriesFromSelection })(Root);
...
exports.removeFaultyStory = exports.updateStore = exports.updateScreen = exports.removeStoryFromSelection = exports.removeAllStoriesFromSelection = exports.addAllStoriesToSelection = exports.addStoryToSelection = exports.increseLoadedCardsCounter = exports.setLoadedCardsCounted = exports.setLoaderText = exports.toggleLoader = exports.updateIndex = exports.updateTopStories = undefined;

var _types = __webpack_require__(15);

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

var updateTopStories = exports.updateTopStories = function updateTopStories(_ref) {
	var topStories = _ref.topStories;

	return {
		type: _types.UPDATE_TOP_STORIES,
		payload: topStories
	};
};

var updateIndex = exports.updateIndex = function updateIndex(index) {
	return {
		type: _types.UPDATE_INDEX,
		payload: index
	};
};

var toggleLoader = exports.toggleLoader = function toggleLoader(flag) {
	return {
		type: _types.TOGGLE_LOADER,
		payload: flag
	};
};

var setLoaderText = exports.setLoaderText = function setLoaderText(text) {
	return {
		type: _types.SET_LOADER_TEXT,
		payload: text
	};
};

var setLoadedCardsCounted = exports.setLoadedCardsCounted = function setLoadedCardsCounted(counter) {
	return {
		type: _types.SET_LOADED_CARDS_COUNTER,
		payload: counter
	};
};
...
var increseLoadedCardsCounter = exports.increseLoadedCardsCounter = function increseLoadedCardsCounter() {
...
var addStoryToSelection = exports.addStoryToSelection = function addStoryToSelection(storyId) {
	return function (dispatch, getState) {
		var selectedStories = getState().currentState.selectedStories.concat(storyId);
		/* selectedStories.push(storyId); */
		dispatch({
			type: _types.UPDATE_SELECTED_STORIES,
			payload: selectedStories
		});
	};
};

var addAllStoriesToSelection = exports.addAllStoriesToSelection = function addAllStoriesToSelection(flag) {
	return function (dispatch, getState) {
		var index = getState().currentState.index;
...
var removeAllStoriesFromSelection = exports.removeAllStoriesFromSelection = function removeAllStoriesFromSelection(flag) {
	return function (dispatch, getState) {
...
var removeStoryFromSelection = exports.removeStoryFromSelection = function removeStoryFromSelection(storyId) {
	return function (dispatch, getState) {
		var selectedStories = [].concat(_toConsumableArray(getState().currentState.selectedStories));
...
var updateScreen = exports.updateScreen = function updateScreen(screen) {
	return function (dispatch, getState) {
		dispatch({
			type: _types.UPDATE_SCREEN,
			payload: screen
		});
	};
};

var updateStore = exports.updateStore = function updateStore(story) {
	return function (dispatch, getState) {
		if (!getState().currentState.storyStore.hasOwnProperty(story.id)) {
			...
			dispatch({
				type: _types.UPDATE_STORY_STORE,
				payload: store
			});
		}
	};
...
var removeFaultyStory = exports.removeFaultyStory = function removeFaultyStory(storyId) {
	return function (dispatch, getState) {
		var currentTopStories = [].concat(_toConsumableArray(getState().currentState.topStories));
		currentTopStories.splice(getState().currentState.topStories.indexOf(storyId), 1);
		var refreshedStories = [].concat(_toConsumableArray(currentTopStories));
		dispatch({
			type: _types.UPDATE_TOP_STORIES,
...
var Card = function (_Component) {
	...
	function Card() {
		...
		_this.calculateComments = _this.calculateComments.bind(_this);
	...
	_createClass(Card, [{
		...
		value: function componentDidMount() {
			...
			if (store.hasOwnProperty(self.props.id)) {
				...
				_axios2.default.get(this.props.url + this.props.id).then(function (response) {
  ...
  componentDidUpdate(){
  	...
  	this.props.increseLoadedCardsCounter();
		...
		key: 'calculateComments',
		value: function calculateComments() {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ ref: function ref(cardDOM) {
						_this2.cardDOM = cardDOM;
					}, className: cardClasses, onClick: this.toggleSelection, tabIndex: '0', onKeyPress: this.handleKeyPress },
				this.props.isSelected ? _react2.default.createElement('div', { className: 'selectedMark' }) : '',
				...
				_react2.default.createElement(
					...
					this.state.story !== '' ? 'By ' + this.state.story.author : '',
					' | ',
					this.state.story !== '' ? this.calculateComments() : ''
				)
			);
		}
	}]);
...
var mapStateToProps = function mapStateToProps(_ref) {
	...
	var selectedStories = currentState.selectedStories;

	return { selectedStories: selectedStories };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, { increseLoadedCardsCounter: _actions.increseLoadedCardsCounter, addStoryToSelection: _actions.addStoryToSelection, removeStoryFromSelection: _actions.removeStoryFromSelection, updateStore: _actions.updateStore, removeFaultyStory: _actions.removeFaultyStory })(Card);
...
var Loader = function (_Component) {
    ...
    _createClass(Loader, [{
        key: 'render',
        value: function render() {
            var cssClasses = 'loader-container' + (this.props.currentState.loader ? '' : ' none');
            return _react2.default.createElement(
                'div',
                { className: cssClasses },
                _react2.default.createElement('img', { src: 'rings.svg', width: '100' }),
                _react2.default.createElement(
                    'label',
                    null,
                    this.props.currentState.loaderText
                )
            );
        }
    }]);
...
var MainMenu = function (_Component) {
    ...
    function MainMenu() {
        ...
        _this.openReadingSession = _this.openReadingSession.bind(_this);
        _this.goBackToTopStories = _this.goBackToTopStories.bind(_this);
        return _this;
    }
    ...
    _createClass(MainMenu, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.currentScreen == 'list_stories' ? _react2.default.createElement(
                    'div',
                    { className: containerClasses },
                    _react2.default.createElement(
                        'span',
                        { className: 'on-select-menu', onClick: this.openReadingSession },
                        _react2.default.createElement('span', { className: 'glyphicon glyphicon-eye-open', 'aria-hidden': 'true' }),
                        'Start Reading'
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: 'on-select-menu', onClick: this.selectAll },
                        _react2.default.createElement('span', { className: 'glyphicon glyphicon-ok', 'aria-hidden': 'true' }),
                        'Select All'
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: 'on-select-menu', onClick: this.deselectAll },
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'on-select-menu', onClick: this.goBackToTopStories },
                        _react2.default.createElement('span', { className: 'glyphicon glyphicon-eye-open', 'aria-hidden': 'true' }),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { addAllStoriesToSelection: _actions.addAllStoriesToSelection, removeAllStoriesFromSelection: _actions.removeAllStoriesFromSelection, updateScreen: _actions.updateScreen })(MainMenu);
...
var _SidebarCard = __webpack_require__(109);

var _SidebarCard2 = _interopRequireDefault(_SidebarCard);
...
var StoryMode = function (_Component) {
    ...
    function StoryMode() {
        ...
        var _this = _possibleConstructorReturn(this, (StoryMode.__proto__ || Object.getPrototypeOf(StoryMode)).call(this));

        _this.generateSideBar = _this.generateSideBar.bind(_this);
        _this.hideSpinner = _this.hideSpinner.bind(_this);
        _this.changeCurrentStory = _this.changeCurrentStory.bind(_this);
        _this.showReloadBtn = _this.showReloadBtn.bind(_this);
        _this.state = {
            loader: true,
            reload: false,
    ...
    _createClass(StoryMode, [{
        ...
        value: function generateSideBar() {
            ...
            for (var i = 0; i < this.props.selectedStories.length; i++) {
                cards.push(_react2.default.createElement(_SidebarCard2.default, { key: this.props.selectedStories[i] /* onClickHandler={this.changeCurrentStory(this.props.storyStore[this.props.selectedStories[i]])} */
        ...
        key: 'render',
        value: function render() {
            var iframeClasses = (0, _classnames2.default)({
                'none': this.state.loader
            });
            return _react2.default.createElement(
                'div',
                { className: 'storyMode-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'storyMode' },
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.currentStory.author,
                            ' | ',
                            this.state.currentStory.created_at
                        ),
                        this.state.loader ? _react2.default.createElement(
                            'div',
                            { className: 'spinner-container' },
                            _react2.default.createElement('img', { src: 'Spinner.svg', width: '100' }),
                            _react2.default.createElement(
                                'label',
                                null,
                        ...
                        this.state.reload ? _react2.default.createElement(
                            'div',
                            { className: 'reload-container' },
                            _react2.default.createElement('img', { src: 'refresh.svg', width: '100' }),
                            _react2.default.createElement(
                                'label',
                                null,
                                'Could not load the story. Click here to try again.'
                            )
                        ) : '',
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'iframe',
                                { className: iframeClasses, onLoad: this.hideSpinner, onCancel: this.showReloadBtn, src: this.state.currentStory.url },
                        ...
                        this.state.currentStory.children !== undefined && this.state.currentStory.children.length > 0 ? _react2.default.createElement(_Comments2.default, { comments: this.state.currentStory.children.filter(function (child) {
                                return child.type == 'comment';
                            }) }) : 'No comments found'
                    )
                )
...
var mapStateToProps = function mapStateToProps(_ref) {
    var currentState = _ref.currentState;
    var selectedStories = currentState.selectedStories,
        storyStore = currentState.storyStore;

    return { selectedStories: selectedStories, storyStore: storyStore };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, {})(StoryMode);
...
var SidebarCard = function (_Component) {
    _inherits(SidebarCard, _Component);

    function SidebarCard() {
        _classCallCheck(this, SidebarCard);

        return _possibleConstructorReturn(this, (SidebarCard.__proto__ || Object.getPrototypeOf(SidebarCard)).apply(this, arguments));
    }

    _createClass(SidebarCard, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: cssClasses, onClick: this.props.onClickHandler },
                this.props.title
            );
        }
    }]);
...
var SidebarCard = function (_Component) {
    ...
    function SidebarCard() {
        ...
        var _this = _possibleConstructorReturn(this, (SidebarCard.__proto__ || Object.getPrototypeOf(SidebarCard)).call(this));

        _this.viewSubCards = _this.viewSubCards.bind(_this);
        _this.state = {
            isExpanded: false
        };
        return _this;
    ...
    _createClass(SidebarCard, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: this.state.isExpanded ? 'commentCard-container expanded' : 'commentCard-container' },
                _react2.default.createElement(
                    'div',
                    { className: 'comment-header' },
                    this.props.author
                ),
                this.props.children.length > 0 && !this.state.isExpanded ? _react2.default.createElement(
                    'div',
                    { className: 'comment-footer', onClick: this.viewSubCards },
                    'View replies'
                ) : '',
                _react2.default.createElement('div', { className: cssClasses, dangerouslySetInnerHTML: { __html: this.props.title } }),
                _react2.default.createElement(
                    'div',
                    { className: 'replies-container' },
                    _react2.default.createElement(_Comments2.default, { comments: this.props.children })
                )
            );
        }
    }]);
